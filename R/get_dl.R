...
#' @export
#'
get_referrals <- function(key_list,
                            ...) {
...
#' @export
#'
get_incidents <- function(key_list,
                          ...) {
  ...
  resp_list <- key_list %>%
    purrr::map( ~ deanslist_api(key = ., endpoint = "incidents", ...))
...
#' @export
#'
get_students <- function(key_list,
                          ...) {
  ...
  resp_list <- key_list %>%
    purrr::map( ~ deanslist_api(key = ., endpoint = "students", ...))
...
get_users <- function(key_list,
  ...
  resp_list <- key_list %>%
    purrr::map( ~ deanslist_api(key = ., endpoint = "users", ...))
